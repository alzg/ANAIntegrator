...
public class Derived implements Serializable
{
    ...
    @NotNull
    private Derived.OptionExerciseStyle optionExerciseStyle;
    /**
    ...
    @NotNull
    private Derived.ValuationMethodorTrigger valuationMethodorTrigger;
    /**
     * ISO Underlying Instrument Index
     * <p>
     * Underlying Instrument Index represented in ISO 20022 acceptable format
     * (Required)
     * 
     */
    @JsonProperty("ISOUnderlyingInstrumentIndex")
    @JsonPropertyDescription("Underlying Instrument Index represented in ISO 20022 acceptable format")
    @NotNull
    private Derived.ISOUnderlyingInstrumentIndex iSOUnderlyingInstrumentIndex;
    private final static long serialVersionUID = -2865338886556591933L;
     ...
     * @param iSOUnderlyingInstrumentIndex
     * @param fullName
     ...
     * @param shortName
     */
    public Derived(String fullName, String classificationType, String commodityDerivativeIndicator, String issuerorOperatoroftheTradingVenueIdentifier, String shortName, Derived.UnderlyingAssetType underlyingAssetType, Derived.OptionExerciseStyle optionExerciseStyle, Derived.ValuationMethodorTrigger valuationMethodorTrigger, Derived.ISOUnderlyingInstrumentIndex iSOUnderlyingInstrumentIndex) {
        super();
     ...
     */
    @JsonProperty("OptionExerciseStyle")
    public Derived.OptionExerciseStyle getOptionExerciseStyle() {
     ...
     */
    @JsonProperty("OptionExerciseStyle")
    public void setOptionExerciseStyle(Derived.OptionExerciseStyle optionExerciseStyle) {
        this.optionExerciseStyle = optionExerciseStyle;
    }

    public Derived withOptionExerciseStyle(Derived.OptionExerciseStyle optionExerciseStyle) {
        this.optionExerciseStyle = optionExerciseStyle;
        return this;
    }
     ...
     */
    @JsonProperty("ValuationMethodorTrigger")
    public Derived.ValuationMethodorTrigger getValuationMethodorTrigger() {
     ...
     */
    @JsonProperty("ValuationMethodorTrigger")
    public void setValuationMethodorTrigger(Derived.ValuationMethodorTrigger valuationMethodorTrigger) {
        this.valuationMethodorTrigger = valuationMethodorTrigger;
    }

    public Derived withValuationMethodorTrigger(Derived.ValuationMethodorTrigger valuationMethodorTrigger) {
        this.valuationMethodorTrigger = valuationMethodorTrigger;
        return this;
    }
     ...
     */
    @JsonProperty("ISOUnderlyingInstrumentIndex")
    public void setISOUnderlyingInstrumentIndex(Derived.ISOUnderlyingInstrumentIndex iSOUnderlyingInstrumentIndex) {
        this.iSOUnderlyingInstrumentIndex = iSOUnderlyingInstrumentIndex;
    }

    public Derived withISOUnderlyingInstrumentIndex(Derived.ISOUnderlyingInstrumentIndex iSOUnderlyingInstrumentIndex) {
        this.iSOUnderlyingInstrumentIndex = iSOUnderlyingInstrumentIndex;
        return this;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).append("fullName", fullName).append("classificationType", classificationType).append("commodityDerivativeIndicator", commodityDerivativeIndicator).append("issuerorOperatoroftheTradingVenueIdentifier", issuerorOperatoroftheTradingVenueIdentifier).append("shortName", shortName).append("underlyingAssetType", underlyingAssetType).append("optionExerciseStyle", optionExerciseStyle).append("valuationMethodorTrigger", valuationMethodorTrigger).append("iSOUnderlyingInstrumentIndex", iSOUnderlyingInstrumentIndex).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(optionExerciseStyle).append(issuerorOperatoroftheTradingVenueIdentifier).append(underlyingAssetType).append(iSOUnderlyingInstrumentIndex).append(fullName).append(classificationType).append(commodityDerivativeIndicator).append(valuationMethodorTrigger).append(shortName).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(optionExerciseStyle, rhs.optionExerciseStyle).append(issuerorOperatoroftheTradingVenueIdentifier, rhs.issuerorOperatoroftheTradingVenueIdentifier).append(underlyingAssetType, rhs.underlyingAssetType).append(iSOUnderlyingInstrumentIndex, rhs.iSOUnderlyingInstrumentIndex).append(fullName, rhs.fullName).append(classificationType, rhs.classificationType).append(commodityDerivativeIndicator, rhs.commodityDerivativeIndicator).append(valuationMethodorTrigger, rhs.valuationMethodorTrigger).append(shortName, rhs.shortName).isEquals();
    }

    public enum ISOUnderlyingInstrumentIndex {
        ...
        private final static Map<String, Derived.ISOUnderlyingInstrumentIndex> CONSTANTS = new HashMap<String, Derived.ISOUnderlyingInstrumentIndex>();

        static {
            for (Derived.ISOUnderlyingInstrumentIndex c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        private ISOUnderlyingInstrumentIndex(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static Derived.ISOUnderlyingInstrumentIndex fromValue(String value) {
            Derived.ISOUnderlyingInstrumentIndex constant = CONSTANTS.get(value);
            if (constant == null) {
    ...
    public enum OptionExerciseStyle {
        ...
        EURO("EURO");
        private final String value;
        private final static Map<String, Derived.OptionExerciseStyle> CONSTANTS = new HashMap<String, Derived.OptionExerciseStyle>();

        static {
            for (Derived.OptionExerciseStyle c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }
        ...
        @JsonCreator
        public static Derived.OptionExerciseStyle fromValue(String value) {
            Derived.OptionExerciseStyle constant = CONSTANTS.get(value);
            if (constant == null) {
                throw new IllegalArgumentException(value);
            } else {
                return constant;
    ...
    public enum ValuationMethodorTrigger {
        ...
        LOOKBACK("Lookback"),
        OTHER_PATH_DEPENDENT("Other Path Dependent"),
        OTHER("Other");
        private final String value;
        private final static Map<String, Derived.ValuationMethodorTrigger> CONSTANTS = new HashMap<String, Derived.ValuationMethodorTrigger>();

        static {
            for (Derived.ValuationMethodorTrigger c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }
        ...
        @JsonCreator
        public static Derived.ValuationMethodorTrigger fromValue(String value) {
            Derived.ValuationMethodorTrigger constant = CONSTANTS.get(value);
            if (constant == null) {
                throw new IllegalArgumentException(value);
            } else {
                return constant;
