...
package Response.Rates.Option.CapFloor.InstRefDataReporting.V1;
...
public class Attributes implements Serializable
{
    ...
    /**
     * Underlying Instrument Index
     * <p>
     * Name of the index on which the financial instrument is based
     * (Required)
     * 
     */
    @JsonProperty("UnderlyingInstrumentIndex")
    @JsonPropertyDescription("Name of the index on which the financial instrument is based")
    @NotNull
    private Attributes.UnderlyingInstrumentIndex underlyingInstrumentIndex;
    /**
     * Underlying Instrument Index Term Value
     * <p>
     * Tenor value of the underlying reference rate
     * (Required)
     * 
     */
    @JsonProperty("UnderlyingInstrumentIndexTermValue")
    @JsonPropertyDescription("Tenor value of the underlying reference rate")
    @DecimalMin("-999")
    @DecimalMax("999")
    @NotNull
    private Long underlyingInstrumentIndexTermValue;
    /**
     * Underlying Instrument Index Term Unit
     * <p>
     * Tenor unit of the underlying reference rate
     * (Required)
     * 
     */
    @JsonProperty("UnderlyingInstrumentIndexTermUnit")
    @JsonPropertyDescription("Tenor unit of the underlying reference rate")
    @NotNull
    private Attributes.UnderlyingInstrumentIndexTermUnit underlyingInstrumentIndexTermUnit;
    /**
     * Option Type
     * <p>
    ...
    private final static long serialVersionUID = -463882955030513425L;
     ...
     * @param expiryDate
     * @param optionType
     * @param underlyingInstrumentIndexTermValue
     * @param deliveryType
     * @param underlyingInstrumentIndexTermUnit
     * @param priceMultiplier
     * @param underlyingInstrumentIndex
     */
    public Attributes(Attributes.NotionalCurrency notionalCurrency, String expiryDate, Attributes.UnderlyingInstrumentIndex underlyingInstrumentIndex, Long underlyingInstrumentIndexTermValue, Attributes.UnderlyingInstrumentIndexTermUnit underlyingInstrumentIndexTermUnit, Attributes.OptionType optionType, Double priceMultiplier, Attributes.DeliveryType deliveryType) {
        super();
     ...
     */
    @JsonProperty("UnderlyingInstrumentIndex")
    public Attributes.UnderlyingInstrumentIndex getUnderlyingInstrumentIndex() {
     ...
     */
    @JsonProperty("UnderlyingInstrumentIndex")
    public void setUnderlyingInstrumentIndex(Attributes.UnderlyingInstrumentIndex underlyingInstrumentIndex) {
        this.underlyingInstrumentIndex = underlyingInstrumentIndex;
    }

    public Attributes withUnderlyingInstrumentIndex(Attributes.UnderlyingInstrumentIndex underlyingInstrumentIndex) {
        this.underlyingInstrumentIndex = underlyingInstrumentIndex;
        return this;
    }
     ...
     */
    @JsonProperty("UnderlyingInstrumentIndexTermValue")
    public Long getUnderlyingInstrumentIndexTermValue() {
     ...
     */
    @JsonProperty("UnderlyingInstrumentIndexTermValue")
    public void setUnderlyingInstrumentIndexTermValue(Long underlyingInstrumentIndexTermValue) {
        this.underlyingInstrumentIndexTermValue = underlyingInstrumentIndexTermValue;
    }

    public Attributes withUnderlyingInstrumentIndexTermValue(Long underlyingInstrumentIndexTermValue) {
        this.underlyingInstrumentIndexTermValue = underlyingInstrumentIndexTermValue;
        return this;
    }
     ...
     */
    @JsonProperty("UnderlyingInstrumentIndexTermUnit")
    public Attributes.UnderlyingInstrumentIndexTermUnit getUnderlyingInstrumentIndexTermUnit() {
     ...
     */
    @JsonProperty("UnderlyingInstrumentIndexTermUnit")
    public void setUnderlyingInstrumentIndexTermUnit(Attributes.UnderlyingInstrumentIndexTermUnit underlyingInstrumentIndexTermUnit) {
        this.underlyingInstrumentIndexTermUnit = underlyingInstrumentIndexTermUnit;
    }

    public Attributes withUnderlyingInstrumentIndexTermUnit(Attributes.UnderlyingInstrumentIndexTermUnit underlyingInstrumentIndexTermUnit) {
        this.underlyingInstrumentIndexTermUnit = underlyingInstrumentIndexTermUnit;
        return this;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).append("notionalCurrency", notionalCurrency).append("expiryDate", expiryDate).append("underlyingInstrumentIndex", underlyingInstrumentIndex).append("underlyingInstrumentIndexTermValue", underlyingInstrumentIndexTermValue).append("underlyingInstrumentIndexTermUnit", underlyingInstrumentIndexTermUnit).append("optionType", optionType).append("priceMultiplier", priceMultiplier).append("deliveryType", deliveryType).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(notionalCurrency).append(expiryDate).append(optionType).append(underlyingInstrumentIndexTermValue).append(deliveryType).append(underlyingInstrumentIndexTermUnit).append(priceMultiplier).append(underlyingInstrumentIndex).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(notionalCurrency, rhs.notionalCurrency).append(expiryDate, rhs.expiryDate).append(optionType, rhs.optionType).append(underlyingInstrumentIndexTermValue, rhs.underlyingInstrumentIndexTermValue).append(deliveryType, rhs.deliveryType).append(underlyingInstrumentIndexTermUnit, rhs.underlyingInstrumentIndexTermUnit).append(priceMultiplier, rhs.priceMultiplier).append(underlyingInstrumentIndex, rhs.underlyingInstrumentIndex).isEquals();
    }
    ...
    public enum UnderlyingInstrumentIndex {
        ...
        private final String value;
        private final static Map<String, Attributes.UnderlyingInstrumentIndex> CONSTANTS = new HashMap<String, Attributes.UnderlyingInstrumentIndex>();

        static {
            for (Attributes.UnderlyingInstrumentIndex c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        private UnderlyingInstrumentIndex(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static Attributes.UnderlyingInstrumentIndex fromValue(String value) {
            Attributes.UnderlyingInstrumentIndex constant = CONSTANTS.get(value);
            if (constant == null) {
                throw new IllegalArgumentException(value);
            } else {
                return constant;
    ...
    public enum UnderlyingInstrumentIndexTermUnit {
        ...
        YEAR("YEAR");
        private final String value;
        private final static Map<String, Attributes.UnderlyingInstrumentIndexTermUnit> CONSTANTS = new HashMap<String, Attributes.UnderlyingInstrumentIndexTermUnit>();

        static {
            for (Attributes.UnderlyingInstrumentIndexTermUnit c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        private UnderlyingInstrumentIndexTermUnit(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static Attributes.UnderlyingInstrumentIndexTermUnit fromValue(String value) {
            Attributes.UnderlyingInstrumentIndexTermUnit constant = CONSTANTS.get(value);
            if (constant == null) {
                throw new IllegalArgumentException(value);
            } else {
                return constant;
