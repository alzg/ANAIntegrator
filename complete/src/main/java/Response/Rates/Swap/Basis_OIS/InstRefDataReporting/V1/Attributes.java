...
public class Attributes implements Serializable
{
    ...
    private final static long serialVersionUID = -8107074914226771182L;
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(notionalCurrency, rhs.notionalCurrency).append(expiryDate, rhs.expiryDate).append(referenceRate, rhs.referenceRate).append(referenceRateTermValue, rhs.referenceRateTermValue).append(otherLegReferenceRateTermValue, rhs.otherLegReferenceRateTermValue).append(deliveryType, rhs.deliveryType).append(otherLegReferenceRate, rhs.otherLegReferenceRate).append(otherLegReferenceRateTermUnit, rhs.otherLegReferenceRateTermUnit).append(notionalSchedule, rhs.notionalSchedule).append(priceMultiplier, rhs.priceMultiplier).append(referenceRateTermUnit, rhs.referenceRateTermUnit).isEquals();
    }
