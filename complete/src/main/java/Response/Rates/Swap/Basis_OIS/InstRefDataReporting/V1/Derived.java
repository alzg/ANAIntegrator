...
package Response.Rates.Swap.Basis_OIS.InstRefDataReporting.V1;
...
public class Derived implements Serializable
{
    ...
    /**
     * ISO Other Leg Reference Rate
     * <p>
     * Other leg reference rate represented in ISO 20022 acceptable format
     * (Required)
     * 
     */
    @JsonProperty("ISOOtherLegReferenceRate")
    @JsonPropertyDescription("Other leg reference rate represented in ISO 20022 acceptable format")
    @NotNull
    private Derived.ISOOtherLegReferenceRate iSOOtherLegReferenceRate;
    private final static long serialVersionUID = -6551410027061983829L;
    ...
    public Derived(String fullName, String classificationType, String commodityDerivativeIndicator, Derived.UnderlyingAssetType underlyingAssetType, Derived.SingleorMultiCurrency singleorMultiCurrency, String issuerorOperatoroftheTradingVenueIdentifier, String shortName, Derived.ISOReferenceRate iSOReferenceRate, Derived.ISOOtherLegReferenceRate iSOOtherLegReferenceRate) {
        ...
        this.iSOOtherLegReferenceRate = iSOOtherLegReferenceRate;
    }
     ...
     */
    @JsonProperty("ISOOtherLegReferenceRate")
    public Derived.ISOOtherLegReferenceRate getISOOtherLegReferenceRate() {
        return iSOOtherLegReferenceRate;
    }
     ...
     */
    @JsonProperty("ISOOtherLegReferenceRate")
    public void setISOOtherLegReferenceRate(Derived.ISOOtherLegReferenceRate iSOOtherLegReferenceRate) {
        this.iSOOtherLegReferenceRate = iSOOtherLegReferenceRate;
    }

    public Derived withISOOtherLegReferenceRate(Derived.ISOOtherLegReferenceRate iSOOtherLegReferenceRate) {
        this.iSOOtherLegReferenceRate = iSOOtherLegReferenceRate;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(underlyingAssetType, rhs.underlyingAssetType).append(issuerorOperatoroftheTradingVenueIdentifier, rhs.issuerorOperatoroftheTradingVenueIdentifier).append(iSOReferenceRate, rhs.iSOReferenceRate).append(fullName, rhs.fullName).append(classificationType, rhs.classificationType).append(commodityDerivativeIndicator, rhs.commodityDerivativeIndicator).append(shortName, rhs.shortName).append(iSOOtherLegReferenceRate, rhs.iSOOtherLegReferenceRate).append(singleorMultiCurrency, rhs.singleorMultiCurrency).isEquals();
    }

    public enum ISOOtherLegReferenceRate {
        ...
        private final static Map<String, Derived.ISOOtherLegReferenceRate> CONSTANTS = new HashMap<String, Derived.ISOOtherLegReferenceRate>();

        static {
            for (Derived.ISOOtherLegReferenceRate c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        private ISOOtherLegReferenceRate(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static Derived.ISOOtherLegReferenceRate fromValue(String value) {
            Derived.ISOOtherLegReferenceRate constant = CONSTANTS.get(value);
            if (constant == null) {
