...
public class Attributes implements Serializable
{
    ...
    private final static long serialVersionUID = 3609382636108136586L;
    ...
    public String toString() {
        return new ToStringBuilder(this).append("notionalCurrency", notionalCurrency).append("expiryDate", expiryDate).append("referenceRate", referenceRate).append("referenceRateTermValue", referenceRateTermValue).append("referenceRateTermUnit", referenceRateTermUnit).append("otherNotionalCurrency", otherNotionalCurrency).append("notionalSchedule", notionalSchedule).append("deliveryType", deliveryType).append("priceMultiplier", priceMultiplier).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(notionalCurrency).append(expiryDate).append(referenceRate).append(referenceRateTermValue).append(deliveryType).append(otherNotionalCurrency).append(notionalSchedule).append(priceMultiplier).append(referenceRateTermUnit).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(notionalCurrency, rhs.notionalCurrency).append(expiryDate, rhs.expiryDate).append(referenceRate, rhs.referenceRate).append(referenceRateTermValue, rhs.referenceRateTermValue).append(deliveryType, rhs.deliveryType).append(otherNotionalCurrency, rhs.otherNotionalCurrency).append(notionalSchedule, rhs.notionalSchedule).append(priceMultiplier, rhs.priceMultiplier).append(referenceRateTermUnit, rhs.referenceRateTermUnit).isEquals();
    }
