...
/**
 * Rates.Swap.Fixed_Float.InstRefDataReporting.V1
 * <p>
 * Record template for Rates.Swap.Fixed_Float
 * 
 */
...
public class RatesSwapFixedFloat implements Serializable
{
    ...
    private final static long serialVersionUID = 7737783484476417424L;

    /**
     * No args constructor for use in serialization
     * 
     */
    public RatesSwapFixedFloat() {
    }
     ...
     * @param iSIN
     */
    public RatesSwapFixedFloat(Long templateVersion, Header header, ISIN iSIN, Derived derived, Attributes attributes) {
        super();
    ...
    public RatesSwapFixedFloat withTemplateVersion(Long templateVersion) {
        this.templateVersion = templateVersion;
        return this;
    }
    ...
    public RatesSwapFixedFloat withHeader(Header header) {
        this.header = header;
        return this;
    }
    ...
    public RatesSwapFixedFloat withISIN(ISIN iSIN) {
        this.iSIN = iSIN;
        return this;
    }
    ...
    public RatesSwapFixedFloat withDerived(Derived derived) {
        this.derived = derived;
        return this;
    }
    ...
    public RatesSwapFixedFloat withAttributes(Attributes attributes) {
        this.attributes = attributes;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RatesSwapFixedFloat) == false) {
            return false;
        }
        RatesSwapFixedFloat rhs = ((RatesSwapFixedFloat) other);
