...
package Response.Rates.Swap.Fixed_Float_OIS.InstRefDataReporting.V1;
...
public class Attributes implements Serializable
{
    ...
    private final static long serialVersionUID = -4885289323841151732L;
    ...
    public String toString() {
        return new ToStringBuilder(this).append("notionalCurrency", notionalCurrency).append("expiryDate", expiryDate).append("referenceRate", referenceRate).append("referenceRateTermValue", referenceRateTermValue).append("referenceRateTermUnit", referenceRateTermUnit).append("notionalSchedule", notionalSchedule).append("deliveryType", deliveryType).append("priceMultiplier", priceMultiplier).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(notionalCurrency).append(expiryDate).append(referenceRate).append(referenceRateTermValue).append(deliveryType).append(notionalSchedule).append(priceMultiplier).append(referenceRateTermUnit).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(notionalCurrency, rhs.notionalCurrency).append(expiryDate, rhs.expiryDate).append(referenceRate, rhs.referenceRate).append(referenceRateTermValue, rhs.referenceRateTermValue).append(deliveryType, rhs.deliveryType).append(notionalSchedule, rhs.notionalSchedule).append(priceMultiplier, rhs.priceMultiplier).append(referenceRateTermUnit, rhs.referenceRateTermUnit).isEquals();
    }
