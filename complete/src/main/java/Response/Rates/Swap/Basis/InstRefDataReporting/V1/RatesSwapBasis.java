...
/**
 * Rates.Swap.Basis.InstRefDataReporting.V1
 * <p>
 * Record template for Rates.Swap.Basis
 * 
 */
...
public class RatesSwapBasis implements Serializable
{
    ...
    private final static long serialVersionUID = -6460707467429088653L;

    /**
     * No args constructor for use in serialization
     * 
     */
    public RatesSwapBasis() {
    }
     ...
     * @param iSIN
     */
    public RatesSwapBasis(Long templateVersion, Header header, ISIN iSIN, Derived derived, Attributes attributes) {
        super();
    ...
    public RatesSwapBasis withTemplateVersion(Long templateVersion) {
        this.templateVersion = templateVersion;
        return this;
    }
    ...
    public RatesSwapBasis withHeader(Header header) {
        this.header = header;
        return this;
    }
    ...
    public RatesSwapBasis withISIN(ISIN iSIN) {
        this.iSIN = iSIN;
        return this;
    }
    ...
    public RatesSwapBasis withDerived(Derived derived) {
        this.derived = derived;
        return this;
    }
    ...
    public RatesSwapBasis withAttributes(Attributes attributes) {
        this.attributes = attributes;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RatesSwapBasis) == false) {
            return false;
        }
        RatesSwapBasis rhs = ((RatesSwapBasis) other);
