...
public class Attributes implements Serializable
{
    ...
    private final static long serialVersionUID = -3018878187169289836L;
     ...
     */
    public Attributes(Attributes.NotionalCurrency notionalCurrency, String expiryDate, Attributes.ReferenceRate referenceRate, Long referenceRateTermValue, Attributes.ReferenceRateTermUnit referenceRateTermUnit, Attributes.DeliveryType deliveryType, Double priceMultiplier) {
        super();
    ...
    public String toString() {
        return new ToStringBuilder(this).append("notionalCurrency", notionalCurrency).append("expiryDate", expiryDate).append("referenceRate", referenceRate).append("referenceRateTermValue", referenceRateTermValue).append("referenceRateTermUnit", referenceRateTermUnit).append("deliveryType", deliveryType).append("priceMultiplier", priceMultiplier).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(notionalCurrency).append(expiryDate).append(referenceRate).append(referenceRateTermValue).append(deliveryType).append(priceMultiplier).append(referenceRateTermUnit).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(notionalCurrency, rhs.notionalCurrency).append(expiryDate, rhs.expiryDate).append(referenceRate, rhs.referenceRate).append(referenceRateTermValue, rhs.referenceRateTermValue).append(deliveryType, rhs.deliveryType).append(priceMultiplier, rhs.priceMultiplier).append(referenceRateTermUnit, rhs.referenceRateTermUnit).isEquals();
    }
