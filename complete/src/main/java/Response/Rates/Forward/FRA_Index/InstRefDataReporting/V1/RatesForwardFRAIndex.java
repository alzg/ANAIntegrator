...
/**
 * Rates.Forward.FRA_Index.InstRefDataReporting.V1
 * <p>
 * Record template for Rates.Forward.FRA_Index
 * 
 */
...
public class RatesForwardFRAIndex implements Serializable
{
    ...
    private final static long serialVersionUID = -7381760771692491035L;

    /**
     * No args constructor for use in serialization
     * 
     */
    public RatesForwardFRAIndex() {
    }
     ...
     * @param iSIN
     */
    public RatesForwardFRAIndex(Long templateVersion, Header header, ISIN iSIN, Derived derived, Attributes attributes) {
        super();
    ...
    public RatesForwardFRAIndex withTemplateVersion(Long templateVersion) {
        this.templateVersion = templateVersion;
        return this;
    }
    ...
    public RatesForwardFRAIndex withHeader(Header header) {
        this.header = header;
        return this;
    }
    ...
    public RatesForwardFRAIndex withISIN(ISIN iSIN) {
        this.iSIN = iSIN;
        return this;
    }
    ...
    public RatesForwardFRAIndex withDerived(Derived derived) {
        this.derived = derived;
        return this;
    }
    ...
    public RatesForwardFRAIndex withAttributes(Attributes attributes) {
        this.attributes = attributes;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RatesForwardFRAIndex) == false) {
            return false;
        }
        RatesForwardFRAIndex rhs = ((RatesForwardFRAIndex) other);
