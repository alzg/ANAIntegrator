...
public class Derived implements Serializable
{
    ...
    private final static long serialVersionUID = 3579965985626714295L;
    ...
    public String toString() {
        return new ToStringBuilder(this).append("fullName", fullName).append("classificationType", classificationType).append("commodityDerivativeIndicator", commodityDerivativeIndicator).append("underlyingAssetType", underlyingAssetType).append("returnorPayoutTrigger", returnorPayoutTrigger).append("issuerorOperatoroftheTradingVenueIdentifier", issuerorOperatoroftheTradingVenueIdentifier).append("shortName", shortName).append("iSOReferenceRate", iSOReferenceRate).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(underlyingAssetType).append(returnorPayoutTrigger).append(issuerorOperatoroftheTradingVenueIdentifier).append(iSOReferenceRate).append(fullName).append(classificationType).append(commodityDerivativeIndicator).append(shortName).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(underlyingAssetType, rhs.underlyingAssetType).append(returnorPayoutTrigger, rhs.returnorPayoutTrigger).append(issuerorOperatoroftheTradingVenueIdentifier, rhs.issuerorOperatoroftheTradingVenueIdentifier).append(iSOReferenceRate, rhs.iSOReferenceRate).append(fullName, rhs.fullName).append(classificationType, rhs.classificationType).append(commodityDerivativeIndicator, rhs.commodityDerivativeIndicator).append(shortName, rhs.shortName).isEquals();
    }
