...
package Response.Foreign_Exchange.Option.Vanilla_Option.InstRefDataReporting.V1;
...
public class Derived implements Serializable
{
    ...
    private final static long serialVersionUID = -9102130388163634550L;
     ...
     * @param shortName
     */
    public Derived(String fullName, String classificationType, String commodityDerivativeIndicator, String issuerorOperatoroftheTradingVenueIdentifier, String shortName, Derived.FXType fXType, Derived.UnderlyingAssetType underlyingAssetType, Derived.ValuationMethodorTrigger valuationMethodorTrigger) {
        super();
    ...
    public String toString() {
        return new ToStringBuilder(this).append("fullName", fullName).append("classificationType", classificationType).append("commodityDerivativeIndicator", commodityDerivativeIndicator).append("issuerorOperatoroftheTradingVenueIdentifier", issuerorOperatoroftheTradingVenueIdentifier).append("shortName", shortName).append("fXType", fXType).append("underlyingAssetType", underlyingAssetType).append("valuationMethodorTrigger", valuationMethodorTrigger).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(issuerorOperatoroftheTradingVenueIdentifier).append(fXType).append(underlyingAssetType).append(fullName).append(classificationType).append(commodityDerivativeIndicator).append(valuationMethodorTrigger).append(shortName).toHashCode();
    }
