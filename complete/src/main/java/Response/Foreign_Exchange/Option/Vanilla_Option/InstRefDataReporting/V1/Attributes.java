...
public class Attributes implements Serializable
{
    ...
    private final static long serialVersionUID = -7434079159203434629L;
     ...
     */
    public Attributes(Attributes.NotionalCurrency notionalCurrency, String expiryDate, Attributes.OptionType optionType, Attributes.OptionExerciseStyle optionExerciseStyle, Attributes.OtherNotionalCurrency otherNotionalCurrency, Attributes.DeliveryType deliveryType, Double priceMultiplier) {
        super();
    ...
    public String toString() {
        return new ToStringBuilder(this).append("notionalCurrency", notionalCurrency).append("expiryDate", expiryDate).append("optionType", optionType).append("optionExerciseStyle", optionExerciseStyle).append("otherNotionalCurrency", otherNotionalCurrency).append("deliveryType", deliveryType).append("priceMultiplier", priceMultiplier).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(notionalCurrency).append(expiryDate).append(optionType).append(optionExerciseStyle).append(deliveryType).append(otherNotionalCurrency).append(priceMultiplier).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(notionalCurrency, rhs.notionalCurrency).append(expiryDate, rhs.expiryDate).append(optionType, rhs.optionType).append(optionExerciseStyle, rhs.optionExerciseStyle).append(deliveryType, rhs.deliveryType).append(otherNotionalCurrency, rhs.otherNotionalCurrency).append(priceMultiplier, rhs.priceMultiplier).isEquals();
    }
