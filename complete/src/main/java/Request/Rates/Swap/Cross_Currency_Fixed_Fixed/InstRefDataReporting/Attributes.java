...
public class Attributes implements Serializable
{
    ...
    private final static long serialVersionUID = 1170187630681490995L;
     ...
     */
    public Attributes(Attributes.NotionalCurrency notionalCurrency, String expiryDate, Attributes.OtherNotionalCurrency otherNotionalCurrency, Attributes.NotionalSchedule notionalSchedule, Attributes.DeliveryType deliveryType, Double priceMultiplier) {
        super();
    ...
    public String toString() {
        return new ToStringBuilder(this).append("notionalCurrency", notionalCurrency).append("expiryDate", expiryDate).append("otherNotionalCurrency", otherNotionalCurrency).append("notionalSchedule", notionalSchedule).append("deliveryType", deliveryType).append("priceMultiplier", priceMultiplier).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(notionalCurrency).append(expiryDate).append(deliveryType).append(otherNotionalCurrency).append(notionalSchedule).append(priceMultiplier).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(notionalCurrency, rhs.notionalCurrency).append(expiryDate, rhs.expiryDate).append(deliveryType, rhs.deliveryType).append(otherNotionalCurrency, rhs.otherNotionalCurrency).append(notionalSchedule, rhs.notionalSchedule).append(priceMultiplier, rhs.priceMultiplier).isEquals();
    }
