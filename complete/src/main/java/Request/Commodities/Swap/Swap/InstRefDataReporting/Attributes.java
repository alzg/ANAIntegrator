...
package Request.Commodities.Swap.Swap.InstRefDataReporting;
...
public class Attributes implements Serializable
{
    ...
    private final static long serialVersionUID = -6801847796360680261L;
     ...
     */
    public Attributes(Attributes.NotionalCurrency notionalCurrency, String expiryDate, Attributes.ReturnorPayoutTrigger returnorPayoutTrigger, Attributes.DeliveryType deliveryType, BaseProduct baseProduct, Attributes.TransactionType transactionType, Attributes.FinalPriceType finalPriceType, Attributes.ReferenceRate referenceRate, Double priceMultiplier) {
        super();
    ...
    public Attributes withBaseProduct(BaseProduct baseProduct) {
        this.baseProduct = baseProduct;
        return this;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).append("notionalCurrency", notionalCurrency).append("expiryDate", expiryDate).append("returnorPayoutTrigger", returnorPayoutTrigger).append("deliveryType", deliveryType).append("baseProduct", baseProduct).append("transactionType", transactionType).append("finalPriceType", finalPriceType).append("referenceRate", referenceRate).append("priceMultiplier", priceMultiplier).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(notionalCurrency).append(expiryDate).append(transactionType).append(referenceRate).append(returnorPayoutTrigger).append(baseProduct).append(deliveryType).append(priceMultiplier).append(finalPriceType).toHashCode();
    }
